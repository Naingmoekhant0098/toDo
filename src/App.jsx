...
function App() {
  ...
  const handleDrop = (e, targetList) => {
    ...
    const sourceList = e.dataTransfer.getData("sourceList");
     ...
     if (targetList === "progress") {
       update(ref(database, "toDos/" + draggedItem.id), {
    ...
    <div className=" p-10  w-[90vw} mx-auto">
      <div className="flex flex-col md:flex-row gap-4 justify-around items-center">
        <div className=" flex gap-2">
          <input
            className=" border-1 p-3 rounded-lg border-gray-300"
            value={text}
      ...
      <div className="flex flex-col  md:flex-row  justify-between items-center mt-32">
        <div className="w-[300px]">
          ...
          <div
            className=" border gap-5 border-gray-400 min-h-[400px] mt-4 rounded-lg p-4"
              ...
              return (
                item.status === "pending" && (
                  <div
                    draggable
                    key={index}
                    onDragStart={(e) => handleDragStart(e, item, "pending")}
                    className=" flex gap-3 cursor-pointer p-2 bg-purple-300 mt-3 rounded-lg"
        ...
        <div className="w-[300px]">
          ...
          <div
            className=" border border-gray-400 min-h-[400px] mt-4 rounded-lg p-4"
            onDragOver={handleDragOver}
              ...
              return (
                item.status === "progress" && (
                  <div
                    draggable
                    key={index}
                    onDragStart={(e) => handleDragStart(e, item, "progress")}
                    className=" flex gap-3 cursor-pointer p-2 bg-yellow-300 mt-3 rounded-lg"
              ...
              return (
                item.status === "completed" && (
                  <div
                    draggable
                    key={index}
                    onDragStart={(e) => handleDragStart(e, item, "completed")}
